...
bucket_name = "de-proj"
table_name = 'airlines'
fixed_start_date = date.today()
file_name = f'/data/csv/{table_name}_{fixed_start_date}.csv'




# record = {
#     "ingested_date" : f"{fixed_start_date}",
...
#         query = f'''
#             COPY AVIATIONSTACK_HIST.{table_name} ({header}) 
...
#             thing = '\n' + thing
#             query = f'''
#                 create table AVIATIONSTACK_HIST.{table_name.upper()} ( 
#                     {thing} \n
#                 );
#             '''
#             try:
